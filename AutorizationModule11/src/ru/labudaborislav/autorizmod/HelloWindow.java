...
//		mainPanel.setLayout(new GridLayout (3, 2, 5, 20));
	...
	public class reactclas implements ActionListener{
		public void actionPerformed(ActionEvent e){
			JFrame RegW = new RegistrationWindow(new GetLoginAndPass() {
                @Override
                public void login(String login) {
                    System.out.println("Login in reactclas: " + login);
                }

                @Override
                public void pass(String pass) {
                    System.out.println("Pass in reactclas: " + pass);
                }

                @Override
                public void group(String group) {
                    System.out.println("Group in reactclas: " + group);
                }
            });
