...
public class RegistrationWindow extends JFrame {
    ...
    private final GetLoginAndPass getLoginAndPass;
    ...
    public RegistrationWindow(GetLoginAndPass getLoginAndPass) {
...
//		regData.setLoginreg(JOptionPane.showInputDialog(null, "Введите логин: "));	
        this.getLoginAndPass = getLoginAndPass;
    }
    ...
    public class reactclas implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == regnown) {
                getLoginAndPass.login(logn.getText());
                getLoginAndPass.pass(passn.getText());
                getLoginAndPass.pass(group.getText());
                DataToFile RegOP = new DataToFile();
